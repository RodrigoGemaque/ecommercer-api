shared_examples "paginatable concern" do |factory_name|
  context "when records fits page size" do #quando os rocords couberem nas paginas
  ...
  context "when records does not fit page size" do #quando os rocords couberem nas paginas
